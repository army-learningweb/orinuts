                ...
                <tbody class="data-users">
                    ...
                    @foreach ($categories as $cat)
                        ...
                        @else
                            ...
                            <td class="product_category_{{ $cat->id }} py-3 px-2 flex justify-center items-center">
                            ...
                            <td class="py-3 px-2">
                                <select name="product_category_status" id="product_category_status"
                                    data-id = "{{ $cat->id }}"
                                    class="product_category_status text-xs rounded-md py-1 focus:border-green-500 focus:ring-1 focus:ring-green-500  w-[120px] shadow-sm border-gray-500/30 mt-1">
                            ...
                            <td class="py-3 text-center">
                                <a href="{{ route('admin.product.categories.edit', $cat->id) }}">
                                    <i
                            ...
                            <td class="py-3 text-center">
                                <a href="{{ route('admin.product.categories.destroy', $cat->id) }}"
