<x-app-layout>
    ...
    {{-- topbar --}}
    <x-topbar-content>
        <x-breadcrum href="{{ route('admin.post.categories.list') }}" page_name="Thùng rác" />
    </x-topbar-content>
    ...
    <div class="p-3">
        <div class="additional-task bg-white shadow-md p-4 rounded-md flex justify-between items-center">
            ...
            {{-- quay lại --}}
            <div>
                <x-a-reset href="{{ route('admin.post.categories.list') }}" class="px-5">
    ...
    <div class="data-table p-3 pt-0">
        @include('admin.post.partials.list_categories_trash')
    </div>
